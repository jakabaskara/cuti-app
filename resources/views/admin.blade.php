<x-layout.default>
    ...
    <div class="flex justify-between">
        <div class="basis-1/2 flex-grow-2">
            <h1 class="text-3xl text-black dark:text-white">Regional Lima Cuti Online</h1>
        </div>
        <div class="basis-1/2">
            <h1 class="text-3xl text-black dark:text-white">Bagian SDM & Sistem Manajemen</h1>
        </div>
    </div>
                    ...
                    <table class="w-full">
                        <thead>
                            <tr>
                                ...
                                <th class="text-center">Sisa Cuti Panjang</th>
                    ...
                    <div class="flex items-center gap-2 mb-5">
                        ...
                        <div x-data="modal" class="mb-5">
                            <div class="flex items-center justify-center">
                                <button type="button" class="btn btn-primary" @click="toggle">+ Ajukan Cuti</button>
                            </div>
                                ...
                                <div class="flex items-start justify-center min-h-screen px-4"
                                    ...
                                    <div x-show="open" x-transition x-transition.duration.300
                                        ...
                                        <div
                                            ...
                                            <div class="font-bold text-lg">Ajukan Cuti</div>
                                        ...
                                        <div class="p-5">
                                            <div class="dark:text-white-dark/70 text-base font-medium text-[#1f2937]">
                                                <form>
                                                    ...
                                                    <div class="mb-3">
                                                        <input type="text" placeholder="Alasan Cuti..."
