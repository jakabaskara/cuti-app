                    ...
                    <div class="flex items-center gap-2 mb-5">
                        ...
                        <div x-data="modal" class="mb-5">
                            <div class="flex items-center justify-center">
                                <button type="button" class="btn btn-primary" @click="toggle">+ Tambah Karyawan</button>
                            </div>
                                ...
                                <div class="flex items-start justify-center min-h-screen px-4"
                                    ...
                                    <div x-show="open" x-transition x-transition.duration.300
                                        ...
                                        <div
                                            ...
                                            <div class="font-bold text-lg">Tambah Karyawan</div>
                                                ...
                                                <form>
                                                    ...
                                                    <div class="mb-3">
                                                        <select id="ctnSelect1" class="form-select text-white-dark"
                                                            required>
                                                            <option>Silahkan Isi Karyawan Baru</option>
                                                            <option>One</option>
                                                            <option>Two</option>
                                                            <option>Three</option>
                                                        </select>
